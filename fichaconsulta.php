		...
		<div class="col-md-8 margin-top">
			...
			<div class="panel-heading">Moveis</div>
				<div class="panel-body">
					<fieldset><legend>Consultar Ficha de moveis</legend>
						<form action="fichademoveisconsulta.php" method="get">
...
<fieldset><legend>Consuta Assistencia de Moveis</legend>
<form action="fichademoveisconsultaassitencia.php" method="get">
<div class="form-inline" class="col-xs-4">
<label>Controle</label>
<input type="text" name="controle"size='14' maxlength="14" placeholder="Controle" value='' OnKeyPress="formatar('#############', this)" class="form-control"/></p>
<label>Nome</label>
